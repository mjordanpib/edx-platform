...
class EntranceExamTestCases(ModuleStoreTestCase):
    ...
    def test_entrance_exam_requirement_message(self):
        ...
        self.assertIn('In order to access the rest of the course, you need to attain', resp.content)
    ...
    def test_entrance_exam_passed_message_and_course_content(self):
        ...
        resp = self.client.get(url)
        self.assertNotIn('In order to access the rest of the course, you need to attain', resp.content)
